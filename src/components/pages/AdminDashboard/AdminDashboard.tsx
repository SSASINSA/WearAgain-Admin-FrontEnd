...
const AdminDashboard: React.FC = () => {
  const statsData = [
    ...
    },
    {
      ...
      icon: "/img/icon/exchange-rate.svg",
      iconBg: "rgba(6, 176, 183, 0.1)",
    },
    {
      title: "지원 파티 횟수",
      ...
      change: "+5%",
      changeType: "positive" as const,
      icon: "/img/icon/support-party.svg",
      iconBg: "rgba(100, 44, 141, 0.1)",
    },
  ];
