...
const ParticipantDetail: React.FC = () => {
  ...
  const display = {
    ...
    avatar: state.avatar ?? mock?.avatar ?? "/img/icon/basic-profile.svg",
              ...
              <div className="summary-left">
                ...
                <div className="summary-meta">
                  ...
                  <div className="inline-stats">
                    <span className="chip">
                      <img src="/img/icon/ticket-icon.svg" alt="티켓" />
                      티켓 {display.ticketCount}장
                    </span>
                    <span className="chip">
                      <img src="/img/icon/credit-icon.svg" alt="크레딧" />
              ...
              <div className="impact-cards">
                <div className="impact-card green">
                  <div className="impact-icon">
                    <img src="/img/icon/co2-impact.svg" alt="CO2" />
                  </div>
                ...
                <div className="impact-card yellow">
                  <div className="impact-icon">
                    <img src="/img/icon/energy-impact.svg" alt="에너지" />
                  </div>
                ...
                <div className="impact-card blue">
                  <div className="impact-icon">
                    <img src="/img/icon/water-impact.svg" alt="물 절약" />
                  </div>
          ...
          <aside className="top-right">
            ...
            <section className="section grow-card">
              ...
              <div className="grow-hero">
                <img src="/img/example/grow-hero.svg" alt="캐릭터" />
              </div>
              ...
              <div className="scissor-box">
                <div className="label">
                  <img src="/img/icon/scissor-icon.svg" alt="가위" />
                  레벨업 가위
                </div>
          ...
          <section className="section clothes-section">
            ...
            <div className="clothes-grid">
              <div className="clothes-item">
                <img src="/img/example/clothes-tshirt.png" alt="친환경 티셔츠" />
                <p>친환경 티셔츠</p>
              </div>
              <div className="clothes-item">
                <img src="/img/example/clothes-jeans.png" alt="지속가능 청바지" />
                <p>지속가능 청바지</p>
              </div>
              <div className="clothes-item">
                <img src="/img/example/clothes-shoes.png" alt="재활용 운동화" />
                <p>재활용 운동화</p>
              </div>
            </div>
          </section>
